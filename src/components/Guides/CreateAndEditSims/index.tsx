...
/**
 * Guide page explaining how to create and edit Sims
 */
export default function CreateAndEditSims() {
  return (
    <div>
      <GuideIndexLink />
      <h1>Adding/Editing Sims</h1>
      <p>
        Every Sims family tree needs Sims so in these guides find out how to add, edit and all about the details
        you can give your sims to tell their life stories.
      </p>
      ...
      <p>
        You'll be shown the people manager view and from here click the <strong>Add Someone New</strong> button.
      </p>
      <p>
        Fill out the details about your Sim and hit <strong>Create Person</strong> at the bottom of the page.
      </p>

      <h2>Edit A Sim</h2>
      <p>
        Once you've created a Sim you can always go back to update them. This will update that Sim anywhere
        they are placed in the tree too.
      </p>
      <p>
        From the tree editor in the toolbar click <strong>Edit</strong> and select <strong>People in Tree</strong>.
      </p>
      ...
      <dl>
        ...
        <dd>
          Start typing to reveal options from the dropdown. You can add as many items to these as you want and if what
          you want isn't there you can add your own items too.
          <div style={{textAlign: 'center'}}>
            <img src={customTrait} alt="Trait Selection Demonstration" width='290'
        ...
        <dt>More (Custom)</dt>
        <dd>
          Add any other details that can be displayed as a title and value. These items will be shown as a
          simple table in the Sims info panel.
        </dd>
      </dl>
