...
/**
 * Guide page explaining how to create a tree
 */
export default function CreateTree() {
  return (
    <div>
      ...
      <h1>Create a Tree</h1>
      <p>
        In this guide you can find out how to create your first tree or remind yourself how to add more to
        your collection.
      </p>
      ...
      <p>
        A trees Title, Descriptions and Cover Image are shown when a tree is displayed in the gallery and in the
        tree info pane.
      </p>
      <p>
        You can emphasize parts of a trees description using the basic formatting options provided such as
        <b>Bold</b>, <i>Italic</i> and <u>Underline</u>.
      </p>
      <p>
        Once you've set everything you want hit <strong>Create Tree</strong> and you'll be taken to the tree editor
        for your new tree.
      </p>
